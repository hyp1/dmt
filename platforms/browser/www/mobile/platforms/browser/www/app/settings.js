...
//Drupal.settings.site_path = 'http://awri.ch'; // e.g. http://www.example.com
Drupal.settings.site_path = 'http://kimo2002.dynu.com/rhfappd7'; // e.g. http://www.example.com
...
drupalgap.settings.menus['user_menu_anonymous'] = {
  ...
  links: [
    ...
    {
        title: 'FBLogin',
        path: '../user/simple-fb-connect?destination=node/1',
        options: {
          InAppBrowser:true,
          attributes: {
            'data-icon': 'lock',
